...
// TestNewWatchTree_Globber tests that certain matches contain a proper static root,
// to optimize the amount of globbing work needed
...
// TestNewWatchTree_GlobTree filters a known directory tree (in ./testdata/) against a glob pattern,
// returning a reduced directory tree (ranging from NOTHING to EVERYTHING)
